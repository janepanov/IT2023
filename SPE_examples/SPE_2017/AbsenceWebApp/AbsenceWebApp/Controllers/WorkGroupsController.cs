...
namespace AbsenceWebApp.Controllers
{
    ...
    public class WorkGroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,WorkLocation,Building")] WorkGroup workGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,WorkLocation,Building")] WorkGroup workGroup)
        {
            if (ModelState.IsValid)
            {
